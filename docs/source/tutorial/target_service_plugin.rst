.. _Tutorial-Target-Service-Plugin:

############################
Make a Target Service Plugin
############################
...
Target service plugins have 2 parts
===================================
...
The target service plugin structure is explained in the header of
