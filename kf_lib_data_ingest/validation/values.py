...
INPUT_VALIDATION = {
    ...
    CONCEPT.GENOMIC_FILE.DATA_TYPE: {
        ...
        constants.GENOMIC_FILE.DATA_TYPE.RAW_FAMILY_COPY_NUMBER_VARIANTS,
        constants.GENOMIC_FILE.DATA_TYPE.RAW_FAMILY_COPY_NUMBER_VARIANTS_INDEX,
        constants.GENOMIC_FILE.DATA_TYPE.RAW_FAMILY_STRUCTURAL_VARIANTS,
        constants.GENOMIC_FILE.DATA_TYPE.RAW_FAMILY_STRUCTURAL_VARIANTS_INDEX,
        constants.GENOMIC_FILE.DATA_TYPE.RAW_GERMLINE_COPY_NUMBER_STRUCTURAL_VARIANTS,
        constants.GENOMIC_FILE.DATA_TYPE.RAW_GERMLINE_COPY_NUMBER_STRUCTURAL_VARIANTS_INDEX,
        constants.GENOMIC_FILE.DATA_TYPE.RAW_GERMLINE_COPY_NUMBER_VARIANTS,
        constants.GENOMIC_FILE.DATA_TYPE.RAW_GERMLINE_COPY_NUMBER_VARIANTS_INDEX,
        constants.GENOMIC_FILE.DATA_TYPE.RAW_GERMLINE_STRUCTURAL_VARIANTS,
        constants.GENOMIC_FILE.DATA_TYPE.RAW_GERMLINE_STRUCTURAL_VARIANTS_INDEX,
    },
    ...
    CONCEPT.SEQUENCING.UMI_BARCODE_OFFSET: check_positive,
    CONCEPT.SEQUENCING.UMI_BARCODE_SIZE: check_positive,
    CONCEPT.SEQUENCING.CELL_BARCODE_OFFSET: check_positive,
    CONCEPT.SEQUENCING.CELL_BARCODE_SIZE: check_positive,
    CONCEPT.SEQUENCING.CDNA_READ_OFFSET: check_positive,
    CONCEPT.SEQUENCING.TARGET_CELL_NUMBER: check_positive,
    CONCEPT.SEQUENCING.FRACTION_NUMBER: check_positive,
    CONCEPT.SEQUENCING.SEQUENCING_MODE: {
        constants.SEQUENCING.SEQUENCING_MODE.CLR,
        constants.SEQUENCING.SEQUENCING_MODE.CCS,
    },
    CONCEPT.SEQUENCING.END_BIAS: {
        constants.SEQUENCING.END_BIAS.END_3,
        constants.SEQUENCING.END_BIAS.END_5,
        constants.SEQUENCING.END_BIAS.FULL_LENGTH,
    },
    CONCEPT.SEQUENCING.UMI_BARCODE_READ: {
        constants.SEQUENCING.READ_ENUM.INDEX1,
        constants.SEQUENCING.READ_ENUM.INDEX2,
        constants.SEQUENCING.READ_ENUM.READ1,
        constants.SEQUENCING.READ_ENUM.READ2,
    },
    ...
    CONCEPT.SEQUENCING.CDNA_READ: {
        constants.SEQUENCING.READ_ENUM.INDEX1,
        constants.SEQUENCING.READ_ENUM.INDEX2,
        constants.SEQUENCING.READ_ENUM.READ1,
        constants.SEQUENCING.READ_ENUM.READ2,
    },
    CONCEPT.SEQUENCING.ACQUISITION_TYPE: {
        constants.SEQUENCING.ACQUISITION_TYPE.DDA,
        constants.SEQUENCING.ACQUISITION_TYPE.DIA,
    },
