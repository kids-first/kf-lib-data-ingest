...
INPUT_VALIDATION = {
    # PARTICIPANT
    CONCEPT.PARTICIPANT.RACE: null_wrapper({
    ...
    CONCEPT.PARTICIPANT.ETHNICITY: null_wrapper({
        constants.ETHNICITY.HISPANIC,
        constants.ETHNICITY.NON_HISPANIC
    }),
    CONCEPT.PARTICIPANT.GENDER: null_wrapper({
        constants.GENDER.MALE,
        constants.GENDER.FEMALE,
        constants.COMMON.OTHER
    }),
    CONCEPT.PARTICIPANT.SPECIES: null_wrapper({
        constants.SPECIES.DOG,
        constants.SPECIES.HUMAN
    }),
    CONCEPT.PARTICIPANT.CONSENT_TYPE: null_wrapper({
    ...
    CONCEPT.BIOSPECIMEN.ANALYTE: null_wrapper({
    ...
    CONCEPT.BIOSPECIMEN.SAMPLE_PROCUREMENT: null_wrapper({
    ...
    CONCEPT.DIAGNOSIS.CATEGORY: null_wrapper({
    ...
    CONCEPT.SEQUENCING.PAIRED_END: null_wrapper({1, 2}),
    ...
    CONCEPT.OUTCOME.DISEASE_RELATED: null_wrapper({
        constants.OUTCOME.DISEASE_RELATED.YES,
        constants.OUTCOME.DISEASE_RELATED.NO
    }),
    CONCEPT.OUTCOME.VITAL_STATUS: null_wrapper({
    ...
    CONCEPT.PHENOTYPE.OBSERVED: null_wrapper({
    ...
    CONCEPT.READ_GROUP.QUALITY_SCALE: null_wrapper({
    ...
    CONCEPT.SEQUENCING.STRATEGY: null_wrapper({
    ...
    CONCEPT.SEQUENCING.LIBRARY_STRAND: null_wrapper({
    ...
    CONCEPT.SEQUENCING.PLATFORM: null_values({
    ...
    # STUDY
    CONCEPT.STUDY.RELEASE_STATUS: null_wrapper({
    ...
    # STUDY_FILE
    CONCEPT.STUDY_FILE.AVAILABILITY: null_wrapper({
        constants.GENOMIC_FILE.AVAILABILITY.IMMEDIATE,
        constants.GENOMIC_FILE.AVAILABILITY.COLD_STORAGE
    }),
