...
GENDERED_RELATIONSHIPS = {
    # PARTNERS:
    R.SPOUSE: {GENDER.MALE: R.HUSBAND, GENDER.FEMALE: R.WIFE,},
    # PARENTS:
    R.PARENT: {GENDER.MALE: R.FATHER, GENDER.FEMALE: R.MOTHER,},
    # CHILDREN:
    R.CHILD: {GENDER.MALE: R.SON, GENDER.FEMALE: R.DAUGHTER,},
    # SIBLINGS:
    R.SIBLING: {GENDER.MALE: R.BROTHER, GENDER.FEMALE: R.SISTER,},
    R.TWIN: {GENDER.MALE: R.TWIN_BROTHER, GENDER.FEMALE: R.TWIN_SISTER,},
    ...
    R.HALF_SIBLING: {GENDER.MALE: R.HALF_BROTHER, GENDER.FEMALE: R.HALF_SISTER,},
    # GRANDPARENTS:
    ...
    R.GRANDPARENT: {GENDER.MALE: R.GRANDFATHER, GENDER.FEMALE: R.GRANDMOTHER,},
    # GRANDCHILDREN:
    ...
    R.GRANDCHILD: {GENDER.MALE: R.GRANDSON, GENDER.FEMALE: R.GRANDDAUGHTER,},
    # GREAT GRANDPARENTS:
    ...
    R.PIBLING: {GENDER.MALE: R.UNCLE, GENDER.FEMALE: R.AUNT,},
    # NIECES/NEPHEWS:
    R.MATERNAL_NIBLING: {
    ...
    R.NIBLING: {GENDER.MALE: R.NEPHEW, GENDER.FEMALE: R.NIECE,},
    # GREAT AUNTS/UNCLES:
    ...
    R.GREAT_PIBLING: {GENDER.MALE: R.GREAT_UNCLE, GENDER.FEMALE: R.GREAT_AUNT,},
    # GREAT NIECES/NEPHEWS:
    ...
    R.GREAT_NIBLING: {GENDER.MALE: R.GREAT_NEPHEW, GENDER.FEMALE: R.GREAT_NIECE,},
    # COUSINS: n/a
}
