...
def test_unique_keys(transform_stage, df):
    ...
    df = transform_stage._add_unique_key_cols(df)
...
def test_compound_unique_keys(transform_stage):
    """
...
def test_no_key_comp_defined(transform_stage):
    """
    ...
    with pytest.raises(AssertionError) as e:
        transform_stage._add_unique_key_cols(df)
